...
function Linkes() {
  ...
  return (
    <div>
      <div>
        <div className={("absolute  top-12 bg-zinc-100  w-48  h-screen    right-0  flex-col flex gahover:p-2 red text-center py-2  overflow-hidden  t-all  ") + (active? " block  ":"hidden   ")}>
